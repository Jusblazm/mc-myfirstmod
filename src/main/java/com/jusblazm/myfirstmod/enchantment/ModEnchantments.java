package com.jusblazm.myfirstmod.enchantment;

import com.jusblazm.myfirstmod.MyFirstMod;
import com.jusblazm.myfirstmod.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantments {
    public static final ResourceKey<Enchantment> LIGHTNING_STRIKER = ResourceKey.create(Registries.ENCHANTMENT,
            ResourceLocation.fromNamespaceAndPath(MyFirstMod.MOD_ID, "lightning_striker"));
